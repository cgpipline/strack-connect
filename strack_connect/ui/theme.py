...
class MTheme(object):
    ...
    def __init__(self, theme='light', primary_color=None):
        ...
        if resource_path is not None:
            default_qss_file = '{}/qss/main.qss'.format(resource_path)
        else:
            default_qss_file = '{}/resource/qss/main.qss'.format(os.path.dirname(os.getcwd()))
    ...
    def _dark(self):
        ...
        self.menu_background_in_color = "#222222"
    ...
    def _light(self):
        ...
        self.menu_background_in_color = "#eeeeee"
